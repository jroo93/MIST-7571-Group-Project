...
<table class="header2">
	<tr>
		<td class="header"><h1>Clothing</h1></td>
...
<table class="crumb">
	<tr>
		<td></td>
		<td>
			<a href="home.jsp">Home</a> > Clothing
		</td>
		<td></td>	
	</tr>
</table>
	...
	<tr>
		...
		<td>
			<table class="items">
				<tr>
					<td class="space"></td>
					<td class="item"><img src="images/womens.jpg" height="200" width="250" /><br><a href="womens.jsp">Women's</a></td>
					<td class="space"></td>
					<td class="item"><img src="images/mens.png" height="200" width="250" /><br><a href="mens.jsp">Men's</a></td>
					<td class="space"></td>
					<td class="item"><img src="images/juniors.jpg" height="200" width="250" /><br><a href="juniors.jsp">Juniors</a></td>
					<td class="space"></td>
				</tr>
			</table>
		</td>
